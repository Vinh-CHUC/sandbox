...
namespace One {
template <Tag t> struct A {
  std::string val;
};

std::string fn1(A<Tag::FOO> a) { return a.val; }
...
std::string fn1(AT<Tag::FOO> &a) { return a.val; }
...
std::string operator+(const MyString &lhs, const MyString &rhs) {
