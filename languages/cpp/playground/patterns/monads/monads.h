...
class EBuilder {
  public:
    ...
    tl::expected<std::reference_wrapper<EBuilder>, std::string> setD(const std::string& e);
    tl::expected<std::reference_wrapper<EBuilder>, std::string> setE(const std::string& f);
    tl::expected<std::reference_wrapper<EBuilder>, std::string> setF(const std::string& g);
